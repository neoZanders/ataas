...
@Service
public class ChocoRandomLNSAlgorithmService extends ChocoNaiveAlgorithmService {

    public ChocoRandomLNSAlgorithmService(
    ...
    public AlgorithmType getType() {
        return AlgorithmType.RANDOM_LNS_CHOCO;
    }
